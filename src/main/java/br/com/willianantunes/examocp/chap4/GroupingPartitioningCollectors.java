...
public class GroupingPartitioningCollectors {
	...
	public static void mapFun() {
		...
		// If we want to mandade a certain type like TreeMap instead, it can be done as the following.
	...
	public static void groupingFun() {
		...
		System.out.println("how many of each length we have: " + map5);
		...
		System.out.println("First letter of the first animal \r\n"
				+ "alphabetically of each length: " + map6);
	}
